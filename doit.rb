class Doit < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/matsuokashuhei/doit/releases/download/v0.8.0/doit-macos-x86_64"
      sha256 "e355bc178ba71d9e2efc5c9b893c2a34d3003d36b1fd7304786b24afa18387fd"
    end

    if Hardware::CPU.arm?
      url "https://github.com/matsuokashuhei/doit/releases/download/v0.8.0/doit-macos-aarch64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/matsuokashuhei/doit/releases/download/v0.8.0/doit-linux-x86_64"
      sha256 "e5bb69ccf35f3f1e9cea8a04e4920c28528dc407a65d0fe1de36ffa4bb2c2117"
    end

    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/matsuokashuhei/doit/releases/download/v0.8.0/doit-linux-aarch64"

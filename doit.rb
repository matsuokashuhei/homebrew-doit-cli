class Doit < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      ...
      sha256 "dce0ce8913f122931e89becda06076627a89d14d4463c750b6e5c"
    end

    if Hardware::CPU.arm?
      url "https://github.com/matsuokashuhei/doit/releases/download/v0.3.0/doit-macos-aarch64"
      sha256 "f28bc5d1a35757f8d639b1e663a21e3a92ac0e234d359a5585db5"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.intel?
      ...
      sha256 "1194e6009839529fb840c5afc45e5f72b12e3d07afd2439fb7b6b"
    end

    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/matsuokashuhei/doit/releases/download/v0.3.0/doit-linux-aarch64"
      sha256 "fd33e65a660561070663ec91c3780634157c6d662cbd58eeaf1ac"
    end
  end
